...
import org.firstinspires.ftc.teamcode.Subsystems.Vision.ScoringAlgorithm.*;
...
@TeleOp(name = "TeleOp")
public class TeleopVision extends LinearOpMode {
    double deltaT;
    double timeCurrent;
    double timePre;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive()) {
            ...
            if (twoGamepads) {
                ...
                if(false)
                {
                    Pixel givenpixel = new Pixel();
                    givenpixel.color = PixelColor.Empty;
                    Prototype prototype = new Prototype(telemetry, hardwareMap);
